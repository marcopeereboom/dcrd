...
// sendQueueRegenEvent sends the provided regen even on the internal queue regen
// event channel while respecting the quit channel.  The allows orderly shutdown
